---
title: Installation
description: Getting started with Ring UI
icon: ListStart
---
...
```bash tab="bun"
bunx shadcn@latest add https://ui.ringui.tech/r/utils.json 
```
 
```bash tab="npx"
npx shadcn@latest add https://ui.ringui.tech/r/utils.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://ui.ringui.tech/r/utils.json
```
...
```bash tab="bun"
bunx shadcn@latest add https://ui.ringui.tech/r/card-05.json
```
 
```bash tab="npx"
npx shadcn@latest add https://ui.ringui.tech/r/card-05.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://ui.ringui.tech/r/card-05.json
```
...
```jsx
import Card05 from "@/components/ringui/card/card-05";
...
```bash tab="bun"
bunx shadcn@latest add https://ui.ringui.tech/r/ai-card-generation.json
```
 
```bash tab="npx"
npx shadcn@latest add https://ui.ringui.tech/r/ai-card-generation.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://ui.ringui.tech/r/ai-card-generation.json
```
 ...
 */
import AICardGeneration from "@/components/ringui/AICardGeneration";
...
```bash tab="bun"
bunx shadcn@latest add https://ui.ringui.tech/r/card-05.json -c ./apps/www
```
 
```bash tab="npx"
npx shadcn@latest add https://ui.ringui.tech/r/card-05.json -c ./apps/www
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://ui.ringui.tech/r/card-05.json -c ./apps/www
```
