  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex h-full w-full flex-col items-center justify-center">
        ...
        >
          <h1 className="bg-gradient-to-b from-black to-black/70 bg-clip-text text-6xl font-bold text-transparent drop-shadow-sm md:text-8xl dark:from-white dark:to-white/70">
            {title}
          </h1>
          <p className="bg-gradient-to-b from-black/90 to-black/50 bg-clip-text text-xl font-medium text-transparent md:text-2xl dark:from-white/90 dark:to-white/50">
            {subtitle}
          </p>
        </motion.div>
      </div>
