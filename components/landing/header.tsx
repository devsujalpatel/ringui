          ...
          <div className="flex items-center justify-center w-full flex-col">
            <div
              className=" flex items-center justify-between bg-linear-to-b from-white/90 via-gray-50/90 to-white/90
                            dark:from-zinc-900/90 dark:via-zinc-800/90 dark:to-zinc-900/90  shadow-[0_2px_20px_-2px_rgba(0,0,0,0.1)]  backdrop-blur-md border-x border-b   border-[rgba(230,230,230,0.7)] dark:border-[rgba(70,70,70,0.7)]
              ...
              <div className="relative z-10 flex items-center justify-between w-full gap-2">
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div className="hidden sm:flex items-center gap-4">
                    ...
                    <Link
                      href="https://ringui.pro/templates?utm_source=ringui.com&utm_medium=header"
                      target="_blank"
